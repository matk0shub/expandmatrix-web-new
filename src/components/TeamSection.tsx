...
type MemberConfig = {
  key: 'matejStipcak' | 'matejVenclik' | 'jakubHruza';
  image?: string;
  accent: string;
  linkedin?: string;
  twitter?: string;
...
const MEMBER_CONFIG: MemberConfig[] = [
  {
    key: 'matejStipcak',
    image: '/images/team/matej-stipcak.png',
  ...
  {
    key: 'matejVenclik',
    image: '/images/team/matej-venclik.png',
    ...
    twitter: 'https://x.com/mvenclikai',
  ...
  {
    key: 'jakubHruza',
    accent: 'linear-gradient(135deg, rgba(255, 138, 76, 0.55), rgba(255, 94, 160, 0.28))',
    linkedin: undefined,
    focusCount: 3
  }
];
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.03] via-[#0d0d0d] to-[#050505] shadow-[0_35px_120px_-40px_rgba(0,0,0,0.8)]">
                <div className="relative aspect-[3/4] overflow-hidden">
                  {member.image ? (
                    ...
                    >
                      <span className="text-5xl font-semibold uppercase tracking-[0.35em] text-white/80">
                        {member.name
                          .split(' ')
