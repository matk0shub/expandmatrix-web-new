      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 space-y-12">
        ...
        <div className="relative overflow-hidden rounded-[32px] border border-white/15 bg-white/[0.05] backdrop-blur-[18px] shadow-[0_45px_120px_-60px_rgba(0,0,0,0.8)]">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -top-24 -left-24 h-80 w-80 rounded-full bg-[#00d76b]/20 blur-[120px]" />
            <div className="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-[#00b85c]/18 blur-[130px]" />
