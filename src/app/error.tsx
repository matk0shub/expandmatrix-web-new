...
export default function ErrorPage({
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(0,215,107,0.15),transparent_60%)]"
        aria-hidden="true"
      />
      <div className="relative text-center max-w-md mx-auto px-6 py-12 rounded-3xl border border-white/10 backdrop-blur-sm bg-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
        ...
        <h2 className="text-2xl mb-6 font-semibold">Something went wrong</h2>
